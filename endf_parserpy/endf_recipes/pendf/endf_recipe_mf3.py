...
# Description of MF3 for a PENDF tape. MF3 contains lin-lin interpolable
# cross sections
#
...
#
# var LMTR: flag for reconstruted redundant reactions by RECONR
#           Redundant cross setions available in MF3, or MF23, or used in MF12
#           are calculated by RECONR if partial cross sections are found. The
#           LMTR flag is set equal to 99 for these cases.
#
...
[MAT, 3, MT/ ZA, AWR, 0, LMTR, 0, 0] HEAD
